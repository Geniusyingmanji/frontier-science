"""Oracle: Optimize waveguide cross-section dimensions. Oracle: solve transcendental eigenvalue equation for TE/TM modes."""
import numpy as np
...
def evaluate(design_waveguide):
    try:
        params = np.asarray(design_waveguide(N_PARAMS), dtype=float).ravel()
