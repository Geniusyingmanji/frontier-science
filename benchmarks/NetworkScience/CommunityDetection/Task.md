# CommunityDetection — Maximize modularity of network partition

## Scientific background
Maximize modularity of network partition. This is a well-studied problem with documented baselines and reference solutions.
...
## Rules
- Only edit `solution.py`. Keep the `detect_communities()` signature.
