# DeconvolutionBlind — Blind deconvolution of a blurred noisy image

## Scientific background
Blind deconvolution of a blurred noisy image. This is a well-studied problem with documented baselines and reference solutions.
...
## Rules
- Only edit `solution.py`. Keep the `deconvolve()` signature.
