# PeakFitting — Decompose a spectrum into Gaussian/Lorentzian peaks

## Scientific background
Decompose a spectrum into Gaussian/Lorentzian peaks. This is a well-studied problem with documented baselines and reference solutions.
...
## Rules
- Only edit `solution.py`. Keep the `fit_peaks()` signature.
